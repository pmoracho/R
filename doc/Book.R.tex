...
\begin{figure}[!ht]
  ...
  \caption{Figura 1.2. Un simple gráfico x-y}
  \label{fig:figure.1.2}
\end{figure}

Esto da la gráfica en la Figura 1.3, con los puntos marcados ahora con pequeños
triángulos.

La idea detrás del cálculo del IMC es que este valor debe ser independiente de
la estatura de la persona, dándole así un número único como indicación de si
una persona tiene sobrepeso y en qué medida. Dado que un IMC normal debe ser de
aproximadamente 22.5, usted esperaría ese peso? 

...
En la seccioón \ref{graficos}, vimos como crear un simple gráfico y sobreimponer
...
En esta sección, profundizaremomos en la estructura de un gráfico o plot típico
...
una región central de gráficación rodeada de márgenes. Las coordenadas dentro de
...
gráfico y un subtítulo en la parte inferior, en la llamada al gráfico.

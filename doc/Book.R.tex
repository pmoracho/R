...
Es habitual en los datos estdísticos tener variables categóricas, que indican
algún tipo de subdivisión, como ser clase social, dignóstico
primario, estadio tumoral, etapa de la pubertad de Tanner, etc. Normalmente se
trabajan com algún tipo de código numérico. 

Sin embargo en R podemos definir estas variables como Factores, un tipo de
estructura, que entre otras cosas, permite asignar un nombre descriptivo a
estas categorías.  

Hay ciertos análisis dónde es escencial para R distinguir

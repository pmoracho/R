...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a5paper,11pt,spanish,twoside,onecolumn,openany,extrafontsizes,final]{extbook}
...
% Cuerpo principal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Predicción clínica versus estadística}
\date{\today}
...
\include{02.Capitulo.2}
\include{03.Capitulo.3}
\include{04.Capitulo.4}
\include{05.Capitulo.5}
\include{09.Capitulo.9}
\include{10.Capitulo.10}
\end{document}

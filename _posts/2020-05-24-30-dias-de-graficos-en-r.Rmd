...
```{r dia8, cache=TRUE, fig.height = 6, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia16, cache=TRUE, fig.height = 8, fig.width = 14, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("waffle")

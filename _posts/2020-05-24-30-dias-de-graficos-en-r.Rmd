...
```{r dia1-data, fig.align="center", fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
library("tidyverse")
...
```{r dia2-data, fig.height = 8, fig.width = 14, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
...
```{r dia4-data, fig.height = 8, fig.width = 10, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
...
```{r dia5-data, fig.height = 5, fig.width = 10, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("tidygraph")
library("ggraph")
library("igraph")
...
```{r dia6-data, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia7-data, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggridges")
...
```{r dia8-data, fig.height = 8, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia8, cache=TRUE, fig.height = 9, fig.width = 9, fig.align = "center", warning=FALSE, message=FALSE}
plot_data %>% 
  ggplot(aes(x=HDI, y=casos)) +
  geom_point(color = "#67a9cf", alpha=.5, size=3) +
  geom_smooth(method = 'lm',formula='y ~ x', se=FALSE, color="#ef8a62") +
...
```{r dia9-data, fig.height = 6, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia11-data, fig.height = 8, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("zoo")
library("forcats")
library("scales")
...
```{r dia11, cache=TRUE, fig.height = 6, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
...
```{r dia12-data, fig.height = 8, fig.width = 14, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("forcats")
library("countrycode")
...
```{r dia12, cache=TRUE, fig.height = 8, fig.width = 12, fig.align = "center", warning=FALSE, message=FALSE}
plot_data %>% 
...
```{r dia13-plot, fig.height = 8, fig.width = 14, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia14-data, cache=TRUE, fig.height = 8, fig.width = 14, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggrepel")
library("treemapify")
...
```{r dia14, fig.height = 8, fig.width = 16, fig.align = "center", warning=FALSE, message=FALSE}
plot_data %>%   
...
```{r dia16-data, echo=TRUE, fig.align="center", fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
library("tidyverse")
library("waffle")
...
```{r dia16, echo=TRUE, fig.align="center", fig.height=8, fig.width=10, message=FALSE, warning=FALSE, cache=TRUE}
plot_data %>% 
...
```{r dia17-data, fig.height = 8, fig.width = 16, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggalluvial")
if ("ggelegant" %in% rownames(installed.packages())) {
  library("ggelegant")
...
```{r dia18-data, fig.height = 8, fig.width = 16, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("sf")
...
```{r dia20-data, fig.height = 8, fig.width = 16, fig.align = "center", warning=FALSE, message=FALSE}
library("tidyverse")
library("ggraph")
library("igraph")
...
```{r dia22-data, fig.align="center", fig.height=8, fig.width=16, message=FALSE, warning=FALSE}
library("tidyverse")
library("rtweet")
library("tidytext")
library("ggwordcloud")
...
```{r dia23-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
...
```{r dia24-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
library("sf")
library("viridis")
...
```{r dia25-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
library("ggrepel")
...
```{r dia26-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
...
```{r dia27-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
library("countrycode")
...
```{r dia28-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("circlize")
library("tidyverse")
...
```{r dia29-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
library("GGally")
if ("ggelegant" %in% rownames(installed.packages())) {
  library("ggelegant")
...
Diagrama de la rosa, o también histograma circular.

### Los datos:

```{r dia30-data, fig.align="center", fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library("tidyverse")
